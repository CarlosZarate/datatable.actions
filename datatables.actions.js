function DTActions(options)
{
	...
	{
		case 1:
			divcontainer.css("height","32px");
			divbubble.css("height","40px");
			break;
		case 2:
			divcontainer.css("height","60px");
			divbubble.css("height","68px");
			break;
		case 3:
			divcontainer.css("height","90px");
			divbubble.css("height","98px");
			break;
	}
	...
	this.RowCBFunction = function( nRow, aData, iDisplayIndex )
	{
    	...
    	{
            if(typeof options.beforeAction != "undefined")
                options.beforeAction(nRow, aData, iDisplayIndex);
    		e.preventDefault();
    		var tr = $(this);
			...
			if ( tr.hasClass('row_selected') ) {
				...
				tr.find('[data-toggle="tooltip"]').tooltip({"placement":"top",delay: { show: 100, hide: 1 }});
        	}
		});
    };
